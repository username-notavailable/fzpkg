...
class Head extends Route
{
    ...
    {
        parent::__construct($path, 'HEAD', $name, $where, $whereNumber, $whereAlpha, $whereAlphaNumeric, $whereUuid, $whereUlid, $whereIn, $withTrashed, $scopeBindings, $consumes , $summary, $description, $deprecated);
    }
}
