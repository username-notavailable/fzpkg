...
class Get extends Route
{
    ...
    {
        parent::__construct($path, 'GET', $name, $where, $whereNumber, $whereAlpha, $whereAlphaNumeric, $whereUuid, $whereUlid, $whereIn, $withTrashed, $scopeBindings, $consumes, $summary, $description, $deprecated);
    }
}
