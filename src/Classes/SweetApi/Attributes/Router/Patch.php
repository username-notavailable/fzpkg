...
class Patch extends Route
{
    ...
    {
        parent::__construct($path, 'PATCH', $name, $where, $whereNumber, $whereAlpha, $whereAlphaNumeric, $whereUuid, $whereUlid, $whereIn, $withTrashed, $scopeBindings, $consumes, $summary, $description, $deprecated);
    }
}
