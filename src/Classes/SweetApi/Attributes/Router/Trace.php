...
class Trace extends Route
{
    ...
    {
        parent::__construct($path, 'TRACE', $name, $where, $whereNumber, $whereAlpha, $whereAlphaNumeric, $whereUuid, $whereUlid, $whereIn, $withTrashed, $scopeBindings, $consumes, $summary, $description, $deprecated);
    }
}
